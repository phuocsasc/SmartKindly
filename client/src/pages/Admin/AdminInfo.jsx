// client/src/pages/Admin/AdminInfo.jsx
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                ...
                console.log('✅ [AdminInfo] Fetched user data:', dbUserData);
                ...
                console.error('❌ [AdminInfo] Error fetching user data:', error);
