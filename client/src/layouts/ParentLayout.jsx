...
import ParentHeader from './../components/common/Header/ParentHeader';
import ParentSidebar from './../components/common/Sidebar/ParentSidebar';

function ParentLayout({ children, user = null }) {
