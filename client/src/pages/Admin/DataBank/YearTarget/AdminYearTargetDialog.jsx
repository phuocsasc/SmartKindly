// client/src/pages/Admin/DataBank/YearTarget/AdminYearTargetDialog.jsx
...
function AdminYearTargetDialog({ open, data, onClose, onSuccess }) {
    ...
    useEffect(() => {
        if (open && data) {
            ...
            // ✅ Fetch context info (tên lĩnh vực và kết quả mong đợi)
            fetchContextInfo();
        }
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [open, data]);

    // ✅ Fetch tên đầy đủ của Lĩnh vực và Kết quả mong đợi
        ...
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
            ...
            <DialogContent sx={{ py: 3 }}>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                    {/* ✅ Context Info Box - Hiển thị đầy đủ tên */}
                    <Box
                        sx={{
                            p: 2,
                            bgcolor: '#e3f2fd',
...
export default AdminYearTargetDialog;
