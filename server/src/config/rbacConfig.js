...
export const PERMISSIONS = {
    ...
    // Quản lý danh sách trẻ theo lớp
    VIEW_CHILDREN_BY_CLASS: 'view_children_by_class',
    CREATE_CHILDREN_BY_CLASS: 'create_children_by_class',
    UPDATE_CHILDREN_BY_CLASS: 'update_children_by_class',
    ...
    // Quản lý phiếu dặn dò của phụ huynh
    VIEW_PARENT_REQUEST: 'view_parent_request',
    CREATE_PARENT_REQUEST: 'create_parent_request',
    UPDATE_PARENT_REQUEST: 'update_parent_request',
    DELETE_PARENT_REQUEST: 'delete_parent_request',
};
...
export const ROLE_PERMISSIONS = {
    ...
    [ROLES.TO_TRUONG]: [
        ...
        PERMISSIONS.VIEW_CHILDREN_BY_CLASS,
    ...
    [ROLES.PHU_HUYNH]: [
        ...
        PERMISSIONS.UPDATE_PARENT_REQUEST,
        PERMISSIONS.DELETE_PARENT_REQUEST,
    ],
};
